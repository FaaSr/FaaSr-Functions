...
| `solve` | **Julia** | `solveSIRModel` | Reads the initial conditions and integrates the SIR model with the `OrdinaryDiffEq` solver (`Tsit5`), writing the trajectory to `sir_output.csv` |
